...
export function HowItWorksDesktop() {
    ...
    return (
        <section id="como-funciona" className="bg-gray-100 py-20" ref={containerRef}>
            <div className=" bg-gray-100 flex flex-col items-center gap-10 py-20">
                ...
                >
                    {/* CARD TEXT */}
                    <motion.div className="rounded-xl shadow-lg mr-12"
                        initial="hidden"
                    ...
                    {/* PERSON ANIMATE */}
                    <motion.div
                        className="h-40 w-[45%] rounded-xl shadow-lg ml-12"
                        initial="hidden"
                        animate={isInView1 ? "visible" : "hidden"}
                        variants={cardVariantRight}
                        transition={{ duration: 1.5, delay: 0.2 }}
                    >
                        <PersonBehindPhone width={300} />
                    </motion.div>
                </div>
                ...
                <div
                    id="second-line"
                    ref={ref2}
                    className="flex w-full max-w-4xl justify-between items-center mt-60"
                >
                    {/* PERSON ANIMATE */}
                    <motion.div
                        className="h-40 w-[45%] rounded-xl shadow-lg mr-12"
                        initial="hidden"
                        animate={isInView2 ? "visible" : "hidden"}
                        variants={cardVariantLeft}
                        transition={{ duration: 1.5, delay: 0.2 }}
                    >
                        <CloudInfraWithPerson width={300} />
                    </motion.div>

                    {/* CARD TEXT */}
                    <motion.div className="rounded-xl shadow-lg ml-12"
                        initial="hidden"
                        animate={isInView2 ? "visible" : "hidden"}
                        variants={cardVariantRight}
                        transition={{ duration: 1.5, delay: 0.2 }}
                ...
                >
                    {/* CARD TEXT */}
                    <motion.div className="rounded-xl shadow-lg mr-20"
                        initial="hidden"
                    ...
                    {/* PERSON ANIMATE */}
                    <motion.div
                        className="h-40 w-[45%] rounded-xl shadow-lg ml-20"
                        initial="hidden"
                        animate={isInView3 ? "visible" : "hidden"}
                        variants={cardVariantRight}
                        transition={{ duration: 1.5, delay: 0.2 }}
                    >
                        <DashboardWithPerson width={300} />
                    </motion.div>
                </div>
            </div>
        </section >
